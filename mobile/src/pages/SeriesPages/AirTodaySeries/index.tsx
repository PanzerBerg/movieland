...
const AirTodaySeries = () => {
    ...
    const titles = {
        title1: { buttonTitle: 'Populares', routeName: 'PopularSeries' }, 
        title2: { buttonTitle: 'Top series', routeName: 'TopSeries' }, 
        title3: { buttonTitle: 'Atualmente no ar', routeName: 'OnAirSeries'}
    }
    ...
    function loadItems() {
        ...
        if (appPage != 0 && appPage % 2 != 0) {
            ...
            api.get(Series.airTodaySeries('pt-BR', (page + 1))).then(response => {
    ...
    return (
        <SafeAreaView style={styles.main}>
            <Text style={styles.header}>Novos episódios</Text>
