...
const UpcomingMovies = () => {
    ...
    const titles = {
        title1: { buttonTitle: 'Populares', routeName: 'PopularMovies' },
        title2: { buttonTitle: 'Top filmes', routeName: 'TopMovies' },
        title3: { buttonTitle: 'No cinema', routeName: 'NowPlayingMovies' },
    }
    ...
    function loadItems() {
        ...
        if (appPage != 0 && appPage % 2 != 0) {
            ...
            api.get(Movies.upcomingMovies('pt-BR', (page + 1))).then(response => {
    ...
    return (
        <SafeAreaView style={styles.main}>
            <Text style={styles.header}>Próximos lançamentos</Text>
